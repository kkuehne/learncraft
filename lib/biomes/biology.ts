...
export const biologyBiome = {
    ...
    stations: [
      {
        ...
        locked: false,
        color: '#22c55e',
        route: '/quest/biology/training-camp'
      },
      {
        id: 'anatomy-lab',
        name: 'Anatomie Lab',
      ...
      },
      {
        ...
        name: 'Quiz',
        emoji: '📝',
        description: 'Bronze, Silber und Gold Quiz-Level',
        category: 'wissenscheck',
        requiredXP: 0,
        totalXP: 500,
        locked: false,
        color: '#f59e0b',
        route: '/quest/biology/quiz'
      },
      {
        id: 'physiology-lab',
  ...
  anatomy: {
    id: 'anatomy',
    name: 'Anatomie',
    title: 'Die Anatomie von außen und innen',
      ...
      boss: {
        ...
        tasks: [
          ...
          },
          {
            ...
            correctAnswer: 1,
            hint: 'Kälteres Wasser = langsamererer Stoffwechsel bei Kaltblütern',
            xp: 50
          }
        ]
      }
