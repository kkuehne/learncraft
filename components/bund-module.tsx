...
export function BundModule({ onComplete, isCompleted }: BundModuleProps) {
  ...
  if (showQuiz) {
    return <BundQuiz onComplete={handleQuizComplete} />
  }
    ...
    <div className="animate-fadeIn">
      <div className="bg-gradient-to-br from-amber-900/50 to-orange-900/50 rounded-2xl p-6 mb-6">
        <div className="text-center mb-4">
          ...
          <h3 className="text-xl font-bold text-white mt-2">Der Bund-Generator</h3>
        </div>

        <div className="bg-white/10 rounded-xl p-4 mb-4">
          <p className="text-amber-200">
            Der Bund ist ein heiliger Vertrag zwischen Gott und den Menschen. 
            Er verpflichtet beide Seiten.
          </p>
        </div>
      </div>
      ...
      {showReward && (
        <XPReward amount={35} show={true} message="Bund verstanden!" />
      )}
    </div>
  )
}
